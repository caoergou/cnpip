...
- `cnpip sync` validates the remote manifest before saving it. Mirror probes issue three GET requests to `simple/pip/` and use the median; at least two successful responses are required.
